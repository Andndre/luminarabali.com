<div x-data="customizerApp()" x-init="init()" class="h-[calc(100vh-4rem)] flex">
    ...
    <div class="w-96 shrink-0 overflow-y-auto border-r border-gray-200 bg-white p-5 space-y-6">
        <div class="flex items-center justify-between">
            <a href="{{ $backUrl }}" class="text-sm text-gray-500 hover:text-gray-900">&larr; Kembali</a>
            ...
            <div class="space-y-6">
                ...
                <section>
                    ...
                    <div class="space-y-3">
                        ...
                        <label class="block">
                            <span class="text-xs text-gray-600">Alamat Undangan (slug)</span>
                            <input type="text" x-model="form.slug" class="mt-1 w-full border rounded-lg px-3 py-2 text-sm">
                            <span class="text-xs text-gray-400">/invitation/<span x-text="form.slug || '...'"></span></span>
                        </label>
                        <label class="block">
    ...
    <div class="flex-1 bg-gray-100 p-4">
        <iframe x-ref="preview" src="{{ $previewUrl }}"
    ...
    <div x-show="pickerOpen" x-cloak
        ...
        <div class="bg-white rounded-2xl w-full max-w-5xl h-[80vh] overflow-hidden">
            <iframe x-show="pickerOpen" src="{{ $pickerUrl }}"
...
function customizerApp() {
    return {
        ...
        form: { title: '', slug: '', groom_name: '', bride_name: '', event_date: '' },
