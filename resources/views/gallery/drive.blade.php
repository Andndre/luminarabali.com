    ...
    <script>
        ...
        function setupInfiniteScroll() {
            ...
            const observer = new IntersectionObserver((entries) => {
                if (entries[0].isIntersecting && !loadMoreContainer.classList.contains('hidden')) {
                    // Slight delay to allow CSS transitions and avoid blocking main thread immediately
                    setTimeout(() => {
                        loadMoreItems();
                    }, 50);
                }
