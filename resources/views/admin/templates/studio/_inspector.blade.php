                                    ...
                                    <div class="border border-gray-200 rounded-lg p-2 space-y-2">
                                        ...
                                        <div class="grid grid-cols-2 gap-2">
                                            <select :value="it.position" @change="setOrnItem(field, i, 'position', $event.target.value)"
                                                class="rounded-lg border-gray-200 text-xs px-2 py-1">
                                        ...
                                        <div class="flex items-center gap-2">
                                            <button type="button" @click="setOrnItem(field, i, 'flip_h', !it.flip_h)"
                                                ...
                                                :class="it.flip_h ? 'border-black bg-gray-900 text-white' : 'border-gray-200 text-gray-600 hover:border-black'">
                                                Flip ↔
                                            </button>
                                            <button type="button" @click="setOrnItem(field, i, 'flip_v', !it.flip_v)"
                                                class="flex-1 text-xs rounded-lg border px-2 py-1"
                                                :class="it.flip_v ? 'border-black bg-gray-900 text-white' : 'border-gray-200 text-gray-600 hover:border-black'">
                                                Flip ↕
                                            </button>
                                        </div>
