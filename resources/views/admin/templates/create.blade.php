        ...
        <div class="space-y-4">
            ...
            <div class="mb-4">
                ...
                <select name="hero_slot" class="w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-yellow-500 focus:border-transparent">
                    ...
                    <option value="left-outer" @selected(old('hero_slot') === 'left-outer')>Kiri luar</option>
                    <option value="left-inner" @selected(old('hero_slot') === 'left-inner')>Kiri dalam</option>
                    <option value="center" @selected(old('hero_slot') === 'center')>Tengah (ponsel, ter-scroll otomatis)</option>
                    <option value="right-inner" @selected(old('hero_slot') === 'right-inner')>Kanan dalam</option>
                    <option value="right-outer" @selected(old('hero_slot') === 'right-outer')>Kanan luar</option>
                </select>
