                            ...
                            <div class="flex flex-col gap-3 rounded-xl border border-gray-200 bg-gray-50 p-4 md:flex-row">
                                <div class="w-full flex-1">
                                    ...
                                    <input type="text" :name="`items[${index}][description]`" x-model="item.description"
                                        class="w-full rounded-lg border px-3 py-2 text-sm" placeholder="Nama Item" required>
                                </div>
                                ...
                                <div
                                    ...
                                    <button type="button" @click="removeItem(index)"
                                        class="text-red-500 hover:text-red-700 md:mt-2" x-show="items.length > 1">
            ...
            <div class="sticky top-4 h-fit rounded-2xl border border-gray-100 bg-white p-6 shadow-sm">
                ...
                <div class="mt-6 border-t pt-6">
                    ...
                    <input type="date" name="invoice_date" value="{{ now()->format('Y-m-d') }}"
                        class="mb-3 w-full rounded-lg border px-3 py-2 text-sm" required>

                    <label class="mb-1 block text-sm font-medium text-gray-700">Jatuh Tempo</label>
                    <input type="date" name="due_date" class="w-full rounded-lg border px-3 py-2 text-sm">
                </div>
