                            ...
                            <tr class="hover:bg-gray-50">
                                ...
                                <td class="px-6 py-4 text-right">
                                    <div class="flex justify-end gap-2">
                                        ...
                                        <a href="{{ route('admin.invitations.customizer', $invitation->id) }}" class="inline-flex items-center gap-1 px-3 py-1.5 text-purple-600 hover:bg-purple-50 rounded-lg transition text-sm font-medium" title="Customizer">
                                            Customizer
                                        </a>
